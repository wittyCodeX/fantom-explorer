...
const TableView = props => {
  return (
    <div>
      ...
      <div
        className={`relative mb-2 bg-white text-black  dark:text-gray-300 border-solid border-grey-light dark:border-blue-light  shadow-xl`}
      >
        <div
        ...
        {props.btnLabel &&
          <div className="absolute bottom-0 bg-white  dark:bg-[#2c2e3f] text-xl px-2 py-1 w-full flex justify-center border-solid border-grey-light  dark:border-blue-light  border-t">
            <Link
