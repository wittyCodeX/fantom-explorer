  ...
  return (
    <div>
      ...
      >
        ...
        {props.btnLabel &&
          <div className="absolute bottom-0 bg-white  dark:bg-blue-800 text-xl px-2 py-1 w-full flex justify-center border-solid border-grey-light  dark:border-blue-light  border-t">
            <Link
